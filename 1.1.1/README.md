...
| 1.1.2   | 29.10.2024 | - Change Invoke-APIOAuth2WebRequest (-Body [Hashtable]) to Invoke-APIOAuth2WebRequest (-Body [string]) in case of customize format body json (ex. -Detph X -Compress)
